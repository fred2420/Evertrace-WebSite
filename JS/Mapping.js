...
function GetMap() {
    ...
    Microsoft.Maps.loadModule('HtmlPushpinLayerModule', function () {
        ...
        var pins = [
            new HtmlPushpin(new Microsoft.Maps.Location(truck1.Lat, truck1.Long), htmlTemplate.replace('{text}', ' <img class="radiowave" src="img/PuppleTracker.svg" style="width: 200%; height: 200%;">'), new Microsoft.Maps.Point(10, 10)),
            ...
            new HtmlPushpin(new Microsoft.Maps.Location(48.49596, 9.43048), htmlTemplate.replace('{text}', ' <img class="radiowave" src="img/OrangeTracker.svg" style="width: 200%; height: 200%;">'), new Microsoft.Maps.Point(10, 10)),
        ];
